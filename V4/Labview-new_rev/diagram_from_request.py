...
def generate_case_diagram(topology: dict, family_rulebook: dict | None = None) -> dict:
    from case_library import ensure_old_topology

    return build_bare_minimum_diagram({
        "topology": ensure_old_topology(topology, family_rulebook),
    })
